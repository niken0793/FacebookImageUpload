...
namespace FacebookImageUpload
{
    public partial class CreateAlbum : Form
    {
        ...
        public static string CreateAlbums(string accessToken, string albumName, string privacy = "SELF")
        {
        ...
        {
            string albumID = CreateAlbums(this.acesstoken, tbAlbumName.Text);
        ...
        private void btnCreate_Click(object sender, EventArgs e)
        {
            ...
            if (cmbCreateAlbumType.SelectedItem.ToString().Contains("Friend"))
                type = "ALL_FRIENDS";
            else if (cmbCreateAlbumType.SelectedItem.ToString().Contains("Private"))
                type = "SELF";
            string albumID = CreateAlbums(this.acesstoken, tbCreateAlbumName.Text,type);

            if (!string.IsNullOrEmpty(albumID))
            {
                MessageBox.Show("Your new  album is successfully created", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
                DialogResult = DialogResult.OK;
            }
            else
            {
                MessageBox.Show("Fail to create new album", "error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
